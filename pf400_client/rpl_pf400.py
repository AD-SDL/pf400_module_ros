...
class RPL_PF400(PF400):
    ...
    def rpl_teach_location(self, location:str = None):
        ...
        self.rpl_robot.location_dictionary[location] = [loc_list[0],loc_list[1], loc_list[2], loc_list[3], loc_list[4], loc_list[5]]
    
        # Write the new location the data file
        try:
            with open(file_path, "w") as jsonFile:
                json.dump(self.rpl_robot.robot_data, jsonFile, indent=4)
