...
' File creation date: 04-15-2022 10:57:04

Begin: 1.0

DI: 2000, 0, 0, 0, "Number of axes" = 5
DI: 2001, 0, 0, 0, "Split axis mask" = 0
DI: 2002, 0, 0, 0, "Robot name" = "PreciseFlex 400SX"
DI: 2003, 0, 0, 0, "Axis mask" = 47
...
DI: 2010, 0, 0, 0, "Motor map nodes" = 1, 1, 1, 1, 2
DI: 2012, 0, 0, 0, "Motor name" = "TS4606 100W/100V", "TS4607 200W/200V",
     "TS4603 100W/100V", "TS4601 30W/100V", "TS4632 26W/48V"
...
DI: 2300, 0, 0, 0, "Joint to motor scale factors" = 7698, 1365.3333,
     0, 0, 0, 2141.699346, 0, 0, 0, 1285.019608, 170.599, 0, 0, 0,
     0, 0, 0, 0, 0, 0
...
DI: 2803, 0, 0, 0, "Homing method" = -9, -9, -9, -9, -3
...
DI: 2810, 0, 0, 0, "Homing order" = 1, 2, 3, 4, 5, 0, 0, 0, 0, 0,
     0, 0
...
DI: 10026, 0, 0, 0, "Encoder hardware channel number" = 1, 2, 3, 4,
     1
DI: 10027, 0, 0, 0, "Encoder type" = 45, 45, 45, 45, 47
DI: 10028, 0, 0, 0, "Amplifier hardware channel number" = 1, 2, 3,
     4, 1
DI: 10029, 0, 0, 0, "Amplifier type" = 16, 16, 16, 16, 17
DI: 10030, 0, 0, 0, "Motor commutation method" = 1, 1, 1, 1, 1
DI: 10049, 0, 0, 0, "Robot initialized" = 1

DI: 10104, 0, 0, 0, "Axis configuration word" = 0, 0, 0, 0, 0
DI: 10105, 0, 0, 0, "Home switch DIN signal" = 0, 0, 0, 0, 0
DI: 10106, 0, 0, 0, "Positive overtravel DIN signal" = 0, 0, 0, 0,
     0
DI: 10107, 0, 0, 0, "Negative overtravel DIN signal" = 0, 0, 0, 0,
     0
DI: 10108, 0, 0, 0, "Dedicated DIN selection" = 0, 0, 0, 0, 0
DI: 10110, 0, 0, 0, "Max motor temperature" = 0, 0, 0, 0, 0
DI: 10111, 0, 0, 0, "Warning motor temperature" = 0, 0, 0, 0, 0
...
DI: 10208, 0, 0, 0, "Run-time speed limit, mcnt/sec" = 1.201493E+07,
     1.201493E+07, 1.201493E+07, 1.201493E+07, 0
DI: 10209, 0, 0, 0, "Manual mode speed limit, mcnt/sec" = 1073833,
     32767, 66115, 113865, 0
...
DI: 10257, 0, 0, 0, "Encoder hardware filter config" = 8192, 8192,
     8192, 8192, 1032
DI: 10258, 0, 0, 0, "Number of single turn data bits" = 0, 0, 0, 0,
     0
DI: 10259, 0, 0, 0, "Misc. serial encoder configuration bitmask" = 0,
     0, 0, 0, 0
DI: 10290, 0, 0, 0, "Number of multi-turn data bits" = 0, 0, 0, 0,
     0
...
DI: 10330, 0, 0, 0, "Torque output filter damping ratio" = 0.4, 0,
     0.4, 0.15, 0.4
DI: 10331, 0, 0, 0, "Proportional gain, Kp" = 3, 80, 60, 16, 2
...
DI: 10338, 0, 0, 0, "Accel error gain, Ka" = 0, 440, 0, 20, 100
...
DI: 10368, 0, 0, 0, "Max torque limit for feedforward after error, tcnt" = 0,
     0, 0, 0, 0
DI: 10369, 0, 0, 0, "PID output saturation duration limit, sec" = 0.2,
     0.2, 0.2, 0.2, 0
...
DI: 10683, 0, 0, 0, "Current offset of phase 1, ccnt" = 5, -7, -2,
     -6, -2
DI: 10684, 0, 0, 0, "Current offset of phase 2, ccnt" = 4, 9, -5,
     -3, -1
...
DI: 10710, 0, 0, 0, "PAF twang range convergence factor, (0,1)" = 0.5,
     0.5, 0.5, 0.5, 0
DI: 10712, 0, 0, 0, "PAF twang torque %" = 50, 50, 50, 50, 0
...
DI: 10732, 0, 0, 0, "# of twang-ref checks" = 4, 4, 4, 4, 0
...
DI: 10774, 0, 0, 0, "Search ref check duration, sec" = 1, 1, 1, 1,
     0
DI: 10775, 0, 0, 0, "Commutation offset, mcnt" = 0, 0, 0, 0, 0
